...
class DoublyLinkedList {    // Doubly Linked List consumes extra memory for the pointer to the previous node
    ...
    public:
        ...
        pNode newNode(int num) {
            pNode newNode = new Node;  // 'new' operator is a better alternative to using malloc()
            newNode -> prev = NULL;
            newNode -> data = num;
            newNode -> next = NULL;
            return newNode;
